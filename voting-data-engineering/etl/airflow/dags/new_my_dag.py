...
with DAG(
    dag_id='new_my_dag', # Dag id,
    description="Training ML Models", # Explain what is the DAG used for
    tags=["Data Engineering", "Mark"], # Organize the data pipeline and know who is the DAG file of the team
    start_date=datetime(2023, 1, 1), # Start date of the dag is running (1 Jan 2023)
    schedule='@daily', # The interval of time at which your DAG gets triggered (once every day)
