...
# expect_column_values_less_than_or_equal_three
...
class ColumnValuesLessThanOrEqualThree(ColumnMapMetricProvider):
    # </snippet>
    ...
    condition_metric_name = "column_values.less_than_or_equal_three"
    # </snippet>
...
class ExpectColumnValuesLessThanOrEqualThree(ColumnMapExpectation):
    # </snippet>
    ...
    """Expect values in this column to less than or equal three (3)."""
    ...
    examples = [
        {
            "data": {
                ...
                "random_number": [-2, -1, 0, 1, 2, 3, 4, 5, 6, 7],
            },
            "tests": [
                {
                    ...
                    "out": {
                        ...
                        "unexpected_list": [3, 3, 3, 3, 3, 3, 3, 3, 3, 3],
                    },
                },
                {
                    "title": "other_positive_test",
                    "exact_match_out": False,
                    "include_in_gallery": True,
                    "in": {"column": "some_threes", "mostly": 0.6},
                    "out": {
                        "success": True,
                        "unexpected_index_list": [0, 1, 2, 3, 4, 5],
                        "unexpected_list": [-2, -1, 0, 1, 2, 3],
                    },
                },
                {
                    ...
                    "exact_match_out": False,
                    "include_in_gallery": True,
                    "in": {"column": "some_threes", "mostly": 0.8},
                    "out": {
                        "success": False,
                        "unexpected_index_list": [0, 1, 2, 3, 4, 5],
                        "unexpected_list": [-2, -1, 0, 1, 2, 3],
    ...
    map_metric = "column_values.less_than_or_equal_three"
    # </snippet>
    ...
    library_metadata = {
        "tags": ["column_map", "column_values", "less_than", "or", "equal", "three"],
        "contributors": ["@skhosyih"],
    }
    # </snippet>
...
if __name__ == "__main__":
    ...
    ExpectColumnValuesLessThanOrEqualThree().print_diagnostic_checklist()
#     </snippet>

# Note to users: code below this line is only for integration testing -- ignore!

'''diagnostics = ExpectColumnValuesLessThanOrEqualThree().run_diagnostics()
